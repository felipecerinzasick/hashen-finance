...
urlpatterns = [
    ...
    path('memos/add/', views.add_memo_note, name='add_memo_note'),
    path('memos/<slug:slug>/', views.memo_detail, name='memo_detail'),
    path('dashboard/', views.dashboard, name='dashboard'),
    path('dashboard/stocks/', views.stocks_dashboard, name='stocks_dashboard'),
    path('dashboard/stocks/add/', views.add_stock_holding, name='add_stock_holding'),
    path('dashboard/stocks/holding/<slug:ticker>/', views.stock_holding_detail, name='stock_holding_detail'),
