...
def build_period_report(kind, start_row, end_row, include_movers=False):
    ...
    return {
        ...
        'beginning_nav_display': chf(beginning_nav),
        'ending_nav_display': chf(ending_nav),
        'change_nav_display': signed_chf(ending_nav - beginning_nav),
        'change_pct_display': signed_pct((ending_nav - beginning_nav) / beginning_nav * Decimal('100') if beginning_nav else Decimal('0')),
        'change_direction': 'gain' if ending_nav >= beginning_nav else 'loss',
